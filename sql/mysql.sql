...
CREATE DATABASE IF NOT EXISTS fb DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
INSERT INTO `sys_dict` VALUES (60, 0, '日志类型', 'LOG_TYPE', '', 0, NULL, NULL, NULL, NULL);
INSERT INTO `sys_dict` VALUES (61, 60, '登录', 'TYPE_LOGIN', NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `sys_dict` VALUES (62, 60, '业务异常', 'TYPE_BUSI_EXCEPTION', NULL, 2, NULL, NULL, NULL, NULL);
INSERT INTO `sys_dict` VALUES (63, 60, '系统异常', 'TYPE_SYS_EXCEPTION', NULL, 3, NULL, NULL, NULL, NULL);
...
(
  ...
  `EX_SYNOPSIS` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '异常摘要',
  `EXCEPTION`   text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '异常信息',
  `IP_ADDR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '访问者地址',
  `USER_AGENT`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '用户代理（浏览器信息）',
  `REQUEST_URI` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '请求地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1094863543409512451 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日志记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (160, 'del_log', 'loginLog', '[0],[system],[loginLog],', '清空登录日志', '', '/loginLog/delLoginLog', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (161, 'log_list', 'loginLog', '[0],[system],[loginLog],', '登录日志列表', '', '/loginLog/list', 2, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (6, '欢迎', 'hi，fb旗舰版发布了！', '2017-01-11 08:53:20', 1, '2018-12-28 23:24:48', 1);
